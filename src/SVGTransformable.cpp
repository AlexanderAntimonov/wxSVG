...
wxSVGTransformable* wxSVGTransformable::GetSVGTransformable(wxSVGElement& element) {
  ...
  switch (element.GetDtd()) {
    ...
    GET_TRANSFORMABLE(wxSVG_CLIPPATH_ELEMENT, wxSVGClipPathElement)
    GET_TRANSFORMABLE(wxSVG_USE_ELEMENT, wxSVGUseElement)
    GET_TRANSFORMABLE(wxSVG_IMAGE_ELEMENT, wxSVGImageElement)
    GET_TRANSFORMABLE(wxSVG_DEFS_ELEMENT, wxSVGDefsElement)
    GET_TRANSFORMABLE(wxSVG_FOREIGNOBJECT_ELEMENT, wxSVGForeignObjectElement)
    GET_TRANSFORMABLE(wxSVG_SWITCH_ELEMENT, wxSVGSwitchElement)
    default:
      break;
  }
  return NULL;
